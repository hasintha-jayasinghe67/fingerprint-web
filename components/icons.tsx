/*
 * Inline SVG icons, hand-drawn for this app. Used instead of emoji so the UI
 * has one consistent 1.5px-stroke icon set that inherits currentColor.
 * Size/className are applied to the svg; all icons are square (24x24 grid).
 */
...
export function IconSettings({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
...
export function IconRefresh({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={`${base} ${className}`} aria-hidden="true">
...
export function IconWarning({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={`${base} ${className}`} aria-hidden="true">
...
export function IconMenu({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" className={`${base} ${className}`} aria-hidden="true">
